...
async def ask_code_assistant(request: QueryRequest):
    try:
        print(f"\U0001F4E5 /ask - Received query: {request.query}")
        ...
        print(f"⏱️ Embedding + Retrieval Time: {embed_time:.4f} seconds")
        print(f"✅ /ask - Answer successfully generated.")

        total_time = time.time() - total_start
        print(f"✅ Total Time for /ask: {total_time:.4f} seconds")
